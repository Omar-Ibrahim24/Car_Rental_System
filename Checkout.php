    ...
    <div class='window'>
            ...
            <div class='order-info-content'>
                ...
                <table class='order-table'>
                    <tbody>
                        ...
                        <?php foreach($cart_cars as $cart_car): ?>
                          
                            <td>
                                <br> <span class='thin'><?php echo $cart_car['brand'];?></span>
                                <br> <?php echo $cart_car['model'];?><br> <span class='thin small'><?php echo "Color:". $cart_car['color'];?><br><br></span>
                                <div class="shifting"><?php echo "$". $cart_car['price'];?></div>
                            </td>
                ...
                <div class='total'>
                    ...
                    <span style='font-weight: 1000;  margin-left:170px; text-align:right;'>
        ...
        <div class='credit-info'>
            <div class='credit-info-content'>
                ...
                <input class='pay-btn' type="submit" name="Checkout" value="Checkout">
                </form> 
            </div>
